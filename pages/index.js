    ...
    <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 pointer-events-none">
      ...
      <div className="text-center space-y-8 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-gray-400 max-w-2xl mx-auto font-light">
          Enter a world where education and digital reality merge. Learn, explore, and connect in ways never before possible.
        </p>
  ...
  <div className="relative bg-transparent ">
    <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto px-4 py-16 ">
      {[
        {
          title: "Learn",
          description: "Access educational resources and interactive learning experiences",
          icon: "📚"
        },
        {
          title: "Connect",
          description: "Collaborate with students and educators worldwide",
          icon: "🤝"
        },
        {
          title: "Grow",
          description: "Track your progress and earn verifiable credentials",
          icon: "🎓"
        }
      ].map((feature, index) => (
        <div 
